 ...
 * @author admin
 */
@WebServlet(name = "showDocsByType", urlPatterns = {"/showdocsbytype"})
public class showDocsByType extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Document> allDocuments = (List<Document>) SessionFactory.getInstance().getDocumentDAO().getDocumentsByType(id);
