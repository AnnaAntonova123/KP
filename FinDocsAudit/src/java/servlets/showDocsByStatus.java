 ...
 * @author admin
 */
@WebServlet(name = "showDocsByStatus", urlPatterns = {"/showdocsbystatus"})
public class showDocsByStatus extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Document> allDocuments = (List<Document>) SessionFactory.getInstance().getDocumentDAO().getDocumentsByStatus(id);
