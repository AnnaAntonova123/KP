...
public class deleteDocument extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet delDocument</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet delDocument at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            SessionFactory.getInstance().getDocumentDAO().deleteDocumentById(id);
            ...
            List<Document> allDocuments = (List<Document>) SessionFactory.getInstance().getDocumentDAO().getAllDocuments();
